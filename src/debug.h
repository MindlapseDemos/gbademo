...
extern uint16_t *vblperf_palptr;
extern volatile int vblperf_count;
...
#define panic(...)	panic_impl(get_pc(), __VA_ARGS__)
void panic_impl(void *pc, const char *fmt, ...) __attribute__((noreturn));
